...
class TestApp(object):
    ...
    def _put(self, name, headers=None, data=None):
        return self.client.put(
            url_for(name), headers=headers,
    ...
    def test_put_persistent_config(self, MockedInterface):
        DATA = {'foo': 'bar'}
        response = self._put('persistent_config', data=DATA)
