...
def get_parameters_definitions_updates():
    return _get_sorted_entry_points(
        'netsu.plugins.parameters_definitions_updates')


def get_config_definitions_updates():
    return _get_sorted_entry_points('netsu.plugins.config_definitions_updates')


def get_state_definitions_updates():
    return _get_sorted_entry_points('netsu.plugins.state_definitions_updates')
